...
**本站总访问量<span id="busuanzi_value_site_pv">42296</span>次**

**本站访客数<span id="busuanzi_value_site_uv">29212</span>人次**
...
function updateElapsedTime() {
    ...
    setText('elapsed-percentage', elapsedPercentage.toFixed(10));
    ...
    setText('current-time', `${hours}:${minutes}:${seconds}`);
    setText('current-date', `${year}-${month}-${day}`);
    setText('current-day-of-week', dayOfWeek);
}
