...
{% link LiteLoaderQQNT 官网, https://liteloaderqqnt.github.io, https://avatars.githubusercontent.com/u/95263282?v=4 %}
...
![image-20240625113058842.png](https://free-img.400040.xyz/4/2024/06/25/667a3d3fad587.png)
...
1. 如果clone到了 `plugins` 目录下，修改 `manifest.json` 中 `inject` 为
...
比如在搜索框键入关键词`LiteLoader`和`插件`，即可找到大量[LiteLoaderQQNT生态的插件](https://github.com/search?q=LiteLoader+插件&type=repositories)
...
## 更新QQNT[](https://liteloaderqqnt.github.io/guide/install.html#更新qqnt)
