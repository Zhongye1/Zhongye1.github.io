...
```
quadim E:\TESTRANGE\pic\121\out --ratio 20:18 --stroke-width 1
```

<!-- 图片已丢失: 21.png -->

```
quadim E:\TESTRANGE\pic\121\out --ratio 24:25 --depth 6 --shape circle --bg-color transparent
```
...
都已经包装好了。不过需要注意的是，**目前并不提供稳定性保证**。*（因为我不知道该怎么保证 (○｀ 3′○)）*
