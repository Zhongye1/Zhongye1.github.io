...
function createtime2() {
  ...
  setTimeout(console.log.bind(console, "%c WELCOME %c 欢迎，同志！", "color:white; background-color:#23c682", ""));
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://picss.sunbangyan.cn/2023/12/11/634a9f54c5bec48071f4079cf67d0d6e.jpeg' title='同志，共勉'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://picss.sunbangyan.cn/2023/12/11/634a9f54c5bec48071f4079cf67d0d6e.jpeg' title='生活还是要继续的'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (window.localStorage.getItem("fpson") == undefined || window.localStorage.getItem("fpson") == "1") {
  ...
  var loop = function () {
    ...
    if (now > 1000 + lastTime) {
      ...
      if (fps <= 5) {
        var kd = `<span style="color:#bd0000">卡成ppt了啊</span>`
      } else if (fps <= 15) {
        var kd = `<span style="color:red">电竞帧率</span>`
      } else if (fps <= 25) {
        var kd = `<span style="color:orange">核显玩战地</span>`
      } else if (fps < 35) {
        var kd = `<span style="color:#9338e6">较为卡顿</span>`
      } else if (fps <= 45) {
        var kd = `<span style="color:#08b7e4">较为流畅</span>`
      } else {
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://picdm.sunbangyan.cn/2024/01/06/19249de133237467ef7c7888e23decbc.jpeg);
    --darkmode-bg:url(https://picdl.sunbangyan.cn/2024/01/02/6c3349ca2e82cfdceb98a82519b1d8f2.jpeg);
    --mobileday-bg: url(https://picdm.sunbangyan.cn/2024/01/06/19249de133237467ef7c7888e23decbc.jpeg);
    --mobilenight-bg: url(https://picdl.sunbangyan.cn/2024/01/02/6c3349ca2e82cfdceb98a82519b1d8f2.jpeg);
  }`; 
}
// 切换背景主函数
function changeBg(s) {
